...
describe('og helpers', () => {
  ...
  it('builds metadata with owner and summary', () => {
    ...
    expect(meta.title).toBe('Weather — ClawHubSG')
  ...
  it('uses defaults when owner and summary are missing', () => {
    ...
    expect(meta.title).toBe('parser — ClawHubSG')
    expect(meta.description).toMatch(/ClawHubSG — a Singapore-focused skill registry/i)
